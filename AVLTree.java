...
public class AVLTree {
  ...
  public AVLTree(AVLNode root)
  {
	  ...
	  if(root!=null)
	  {
		  this.root.nodeL=new AVLNode(-1,null);
		  this.root.nodeR=new AVLNode(-1,null);
	  }
  }
  public boolean empty()
  {
 ...
 /**
  ...
  public class AVLNode implements IAVLNode{
	    public int key;
		public String info;
		public AVLNode nodeL;
		public AVLNode nodeR;
		public int hieght;
	    ...
	    {
			this.hieght=setheight(this);
	      return;
	    }
		public int setheight(AVLNode root)
		{
			if(root==null){return 0;}
			if(root.info==null){return -1;}
			return 1+ Math.max(setheight(root.nodeL),setheight(root.nodeR));
		}
	    public int getHeight()
	    {
	      if (this.info!=null){return hieght;}return -1;
	    }
